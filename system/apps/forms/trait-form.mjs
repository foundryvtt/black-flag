...
export default class TraitForm extends FormApplication {
  ...
  async getData() {
    ...
    context.PROFICIENCY_TYPES = BlackFlagSheet.getDatalistOptions(
      CONFIG.SYSTEM.PROFICIENCY_TYPES,
      this.object.innate.proficiencies
    );
    context.LANGUAGE_TYPES = BlackFlagSheet.getDatalistOptions(
      CONFIG.SYSTEM.LANGUAGE_TYPES,
      this.object.innate.languages
    );
    context.RESISTANCE_TYPES = BlackFlagSheet.getDatalistOptions(
      CONFIG.SYSTEM.DAMAGE_TYPES,
      this.object.innate.resistances
    );
    context.SAVE_ADVANTAGE_TYPES = BlackFlagSheet.getDatalistOptions(
      CONFIG.SYSTEM.SAVE_TYPES,
      this.object.innate.saveAdvantages
    );
