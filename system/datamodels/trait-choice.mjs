    ...
    static defineSchema() {
        ...
        return {
            ...
            choices: new fields.ArrayField(new fields.SchemaField({
                ...
                options: new fields.SetField(new fields.StringField(), {required: true, initial: new Set()}),
                chosenValues: new fields.SetField(new fields.StringField(), {required: true, initial: new Set()}),
